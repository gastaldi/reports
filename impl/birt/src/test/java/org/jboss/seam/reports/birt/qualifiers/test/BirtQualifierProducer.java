 ...
 */
package org.jboss.seam.reports.birt.qualifiers.test;
 ...
 */
public class BirtQualifierProducer {
    ...
    @Produces
    @SalesReport
    Report produceSalesReport(@Birt Instance<ReportLoader> loader, ResourceLoaderManager resourceLoader,
                              InjectionPoint ip) {
